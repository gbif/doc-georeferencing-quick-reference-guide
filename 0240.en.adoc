...
[#img-nearby-features]
.The boundaries for two distinct nearby features with the same name, with center *c*, corrected center *a*, and geographic radial *b* covering both possible interpretations of the locality.
