...
If the entire **<<locality>>** is in question, do not **<<georeference>>** and document in term:dwc[georeferenceRemarks] the reason for not **<<georeference,georeferencing>>** (_e.g._, "_locality in question_").
...
Do not **<<georeference>>** these **<<locality,localities>>**. Document in term:dwc[georeferenceRemarks].
...
Multiple unrelated **<<feature,features>>**: Do not **<<georeference>>**. Document in term:dwc[georeferenceRemarks].
